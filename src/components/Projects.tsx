        ...
        <>
            ...
            transition={{ duration: 0.8 }}>
                ...
                <div className="md:w-4/5 md:px-5 md:py-3">
                    <p className="text-[#E2E8F0] flex justify-between items-start mt-1 md:mt-0">
                        ...
                        <a target="_blank" className="cursor-pointer" href="">
                            <div className="flex justify-center items-center">
                                <a target='_blank' href="https://github.com/githubxnishant/DocGPT">
                                ...
                                <a target='_blank' href="https://doc-gpt-tau.vercel.app/">
                    ...
                    <p className="text-[#94A3B8] font-semibold text-sm mb-3">AI-powered document assistant.</p>
